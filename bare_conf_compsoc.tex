...
\input{contents/3_application}
\input{contents/4_architecture}
\input{contents/5_conclusions}
%\input{contents/5_discussion_conclusion}
...
GEOWEB S.p.A., a web service company owned by Sogei S.p.A. and CNGeGL, the ICT company of the Italian Ministry of Economy and Finance and the Italian National Board of Quantity Surveyors, respectively.
  
Authors would like to thank GEOWEB S.p.A., a web service company owned by Sogei S.p.A. and CNGeGL Italian National Board of Quantity Surveyors, respectively. Thanks are extended to Stefano Perrone for developing the models shown in the Figures~\ref{FIGURE-CREATE-DA-STEFANO}.
\else
