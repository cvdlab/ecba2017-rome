...
Authors would like to thank GEOWEB S.p.A., a web service company owned by Sogei S.p.A. and CNGeGL Italian National Board of Quantity Surveyors, for supporting this work. Thanks are extended to Stefano Perrone for developing the models shown in the Figures~\ref{fig2D},~\ref{figCatalogo},~\ref{fig3D-school} and~\ref{fig3D-palace}.
