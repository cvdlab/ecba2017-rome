...
The remainder of this document is organized as follows. Section~\ref{sec:related_work} provides an overview of related work. Section~\ref{sec:methodology} presents adopted architectural solutions. Section ~\ref{sec:results} contains results, some conclusive remarks and figures future developments.
