...
Tuttavia, la completa distributivit\`a dell'architettura, nonostante sia molto efficiente, la rende estremamente difficile da implementare e mantenere. Per questa ragione, almeno in una prima fase iniziale, \`e stata sfruttata la gestione centralizzata dello stato per introdurre una collaborazione centralizzata basata su un nodo \textbf{master}.
